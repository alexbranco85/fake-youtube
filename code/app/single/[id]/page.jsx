...
const Single = () => {
  ...
  const formatText = (text) => {
    ...
    return `<p className="text-black">${formatedText}</p>`;
  }
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-8 gap-6 px-5 md:px-24 py-4 box-content">
        <div className="text-black col-span-8 md:col-span-6">
          {video && (
            <>
              ...
              <p className="text-black font-bold text-xl my-4">{video.title}</p>
              <div className="grid grid-cols-6 gap-6">
                <div className="flex-wrap col-span-6 md:col-span-3 flex gap-2 md:gap-4 items-start md:items-center">
                  <div id="user-avatar">
              ...
              <div className="bg-gray-100 p-8 mt-4 w-full rounded-md text-sm sm:text-xs break-words text-black" dangerouslySetInnerHTML={{ __html: formatText(video.description) }}>
              </div>
            </>
          )}
        </div>
